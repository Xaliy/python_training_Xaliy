class ContactHelper:
    ...
    def create_new_contact(self, contact):
        ...
        # calendars
        wd.find_element_by_xpath('//select[@name="bday"]//option[@value="'
                                 + contact.bday + '"]').click()
        wd.find_element_by_name('bmonth').click()
        wd.find_element_by_xpath('//select[@name="bmonth"]//option[@value="'
                                 + contact.bmonth + '"]').click()
        wd.find_element_by_name('byear').click()
        wd.find_element_by_name('byear').clear()
        wd.find_element_by_name('byear').send_keys(contact.byear)
        wd.find_element_by_name('aday').click()
        wd.find_element_by_xpath('//select[@name="aday"]//option[@value="'
                                 + contact.aday + '"]').click()
        wd.find_element_by_name('amonth').click()
        wd.find_element_by_xpath('//select[@name="amonth"]//option[@value="'
                                 + contact.amonth + '"]').click()
        # text fields
    ...
    def edit_first_contact(self, contact):
        ...
        wd.find_element_by_name("firstname").click()
        wd.find_element_by_name("firstname").clear()
        wd.find_element_by_name("firstname").send_keys("edit_first_name")
        # text fields
        wd.find_element_by_name('firstname').click()
        wd.find_element_by_name('firstname').clear()
        wd.find_element_by_name('firstname').send_keys(contact.firstname)
    ...
    def return_to_home_page(self):
        """Переходим на домашную страницу. Список контактов."""
        wd = self.app.wd
        # home page
